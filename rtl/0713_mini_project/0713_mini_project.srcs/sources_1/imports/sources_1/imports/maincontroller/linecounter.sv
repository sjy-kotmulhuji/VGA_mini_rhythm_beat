...
module line_count(
    ...
    parameter [06:00] LINE_VALUE = 640 / FRAME_NUM;
    ...
    always @ (posedge clk or posedge reset) begin
        ...
        else if(r_en0 && w_vs_dly0_r) begin
    ...
    always @ (posedge clk or posedge reset) begin
        ...
        else if(r_en1 && w_vs_dly0_r) begin
    ...
    always @ (posedge clk or posedge reset) begin
        ...
        else if(r_en2 && w_vs_dly0_r) begin
    ...
    always @ (posedge clk or posedge reset) begin
        ...
        else if(r_en3 && w_vs_dly0_r) begin
